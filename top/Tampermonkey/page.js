this.pagejs = e=>{
    (()=>{
        ...
        const n = e.vault = e.vault || (e=>{
          ...
          , {cSO: o, F_c: r, F_a: s, F_b: a, F_tS: i, A_fE: l, A_so: c, A_sh: d, A_j: u, A_f: g, A_iO: p, A_iA: f, O_a: v, O_k: m, O_v: _, O_dP: b, O_dPy: M, O_hOP: h, O_gOPN: y, O_gOPD: w, O_gOPDs: E, O_gPO: S, O_tS: R, J_p: G, J_s: L, M_f: O, M_r: C, M_m: I, M_mi: T, M_i: x, M_pA: P, M_pAT: D, N_tS: A, N_MSI: k, P_t: U, P_c: $, R_rABS: j, R_rAT: F, R_r: N, R_enq: V, R_cl: q, S_fCC: X, S_sl: B, S_su: H, S_iO: W, S_sp_nr: K, S_tr: J, S_rA_nr: z, S_cCA: Y, S_tLC: Q, S_tUC: Z, Y_tST: ee, D_pFS: te, D_cS: ne, D_gRS: oe, D_cE: re, D_gEBT: se, E_r: ae, E_s: ie, E_rA: le, M_aN: ce, M_rN: de, C_d: ue, U_cOU: ge, U_rOU: pe, USP_tS: fe, X_o: ve, X_s: me, X_pSD: _e, X_pSH: be, X_pSL: Me, X_pSO: he, X_pSU: ye, D_n: we, I_tS: Ee, W_aEL: Se, W_rEL: Re, parseInt: Ge, parseFloat: Le, console: Oe, encodeURIComponent: Ce, decodeURIComponent: Ie, encodeURI: Te, decodeURI: xe, escape: Pe, unescape: De, atob: Ae, btoa: ke, postMessage: Ue, dispatchEvent: $e, alert: je, prompt: Fe, confirm: Ne, close: Ve, getElementById: qe, createEvent: Xe, createElement: Be, CustomEvent: He, CompositionEvent: We, KeyboardEvent: Ke, MouseEvent: Je, MutationEvent: ze, MutationObserver: Ye, Uint8Array: Qe, FileReader: Ze, DOMParser: et, XMLHttpRequest: tt, Function: nt, RegExp: ot, Promise: rt, Blob: st, ReadableStream: at, Number: it, String: lt, Proxy: ct, Window: dt} = n
          , ut = r
          , gt = s
          , pt = m
          , ft = _
                ...
                if (null === e)
                        ...
                        return n(e);
                    {
                        ...
                        return Wt(pt(e), (r=>{
                            const s = e[r];
                            let a;
                            a = "object" == typeof s ? wt(s) ? n(s) : o(s) : s,
                            Ot(t, r, a)
                        }
                        )),
                        t
          ...
          , Kn = (()=>{
            ...
            return Wt(pt(e), (n=>{
                try {
                    ...
                    t[n] = ((e,t)=>{
                        if (Zn.error(`Tampermonkey sandbox preparation ${t ? "(" + t + ") " : ""}failed. This usually is caused by a third-party extension.`, e),
                        t)
                            return ()=>{}
                    }
                    )(e, `document.${n}`)
        ...
        const Zn = e.console = e.console || Lt({})
          , eo = Lt({
            addEventListener: Dt(Se, Yn),
            removeEventListener: Dt(Re, Yn)
        });
        Wt(pt(Jn), (async e=>{
            if (!eo[e])
                try {
        ...
        Wt(pt(Wn), (async e=>{
            if (!eo[e])
                try {
                    let t = It(Yn, e);
                    if (void 0 === t && (Qn === Yn || void 0 === (t = It(Qn, e))))
                        return;
                    const n = Wn[e];
            ...
            return Lt({
                message: (e,n)=>{
                    ...
                    if (e.connect) {
                        ...
                        if (!e.response_id)
                            throw "invalid message";
                        if (!(a = o[e.response_id]))
                            return void t.warn("ports: unkown id", e.response_id, e);
        ...
        ro((()=>{
            uo = !1,
            Wt(go, (({m: e, i: t})=>io.first.send("console", [e, t]))),
            go = []
        }
        )),
        ...
        const vo = ["chrome"]
          ...
          , Mo = ["GM_listValues", "GM.listValues", "GM_getValue", "GM.getValue", "GM_addValueChangeListener", "GM.addValueChangeListener", "GM_removeValueChangeListener", "GM.removeValueChangeListener"]
          ...
          , Uo = (e,t)=>to((n=>{
            ...
            ,
            o.onerror = e=>{
                Zn.warn(`unable to decode data ${e}`),
                n("")
            }
            ,
            t ? dn(o, e, t) : cn(o, e)
        ...
        const No = Lt({})
          ...
          , qo = function(e, t, n, o) {
            ...
            0 === t ? ro((()=>r())) : $o.first.send("setTimeout", Lt({
                t: t || 1
            }), (()=>r())))
        }
          , Xo = e=>{
              ...
              , l = (e,t)=>{
                ...
                const o = new eo.Promise(((o,r)=>{
                    ...
                    s.onerror = function(e) {
                        l ? (o(e),
                        Gt(l, this, arguments)) : r(e)
                    }
                    ,
                    s.ontimeout = function(e) {
                        i ? (o(e),
                        Gt(i, this, arguments)) : r(e)
                    }
                    ,
                    s.onload = function(e) {
                        o(e),
                        a && Gt(a, this, arguments)
                    }
                    ;
                    const c = e(s).abort;
                    !0 === n ? c() : n = c
                ...
                of: e=>{
                    const c = e.script
                      , d = (()=>{
                        ...
                        ;
                        return Lt({
                            GM_setClipboard: e ? Lt({
                                value: t
                            }) : void 0,
                            "GM.setClipboard": e ? Lt({
                                get: ()=>i(t, 2)
                            }) : void 0
                        })
                    }
                      ...
                      , u = (()=>{
                        ...
                        ;
                        (l || d) && (i = ao.connect("values", !0),
                        i.onDisconnect.addListener((()=>{
                            Zn.warn("values: port disconnected"),
                            i = null
                        }
                        ))),
                        i && l && (i.onMessage.addListener((e=>{
                            ...
                            Wt(s, (e=>{
                                const t = o.data[e]
                                  , n = r[e];
                                void 0 === n ? delete o.data[e] : o.data[e] = n,
                                g(e, t, n, !0)
                            }
                            ))
                        }
                        ...
                        return Lt({
                            ...
                            GM_addValueChangeListener: l ? Lt({
                                value: m
                            }) : void 0,
                            "GM.addValueChangeListener": l ? Lt({
                                get: ()=>a(m)
                            }) : void 0,
                            GM_removeValueChangeListener: l ? Lt({
                                value: _
                            }) : void 0,
                            "GM.removeValueChangeListener": l ? Lt({
                                get: ()=>a(_)
                            }) : void 0,
                            GM_setValue: d ? Lt({
                                value: b
                        ...
                        const e = s(c.grant, xo)
                          , t = (()=>{
                            ...
                            return Lt({
                                ...
                                unregister: n=>{
                                    let o;
                                    n && (o = Ht(e, n)) > -1 && (e = jt(e, o, 1).result),
                      ...
                      , p = (()=>{
                        ...
                        ;
                        return Lt({
                            GM_getResourceText: e ? Lt({
                                value: t
                            }) : void 0,
                            "GM.getResourceText": e ? Lt({
                                get: ()=>a(t)
                            }) : void 0,
                            GM_getResourceURL: e ? Lt({
                                value: n
                            }) : void 0,
                            "GM.getResourceUrl": e ? Lt({
                                get: ()=>a(n)
                            }) : void 0
                        })
                    }
                      ...
                      , v = (()=>{
                        const e = s(c.grant, Co)
                          , o = e=>{
                                ...
                                if (n)
                                    ...
                                    s = e || (t ? (e=>{
                                        ...
                                        for (let e = 0; e < n.length; e += 32687)
                                            t += Gt(fn, null, n.subarray(e, e + 32687));
                                        return t
                                    }
                                    )(t) : "");
                                return s
                            ...
                            return (e=>{
                                ...
                                if (!o.data)
                                    return e();
                                d(o.data, (t=>{
                                    o.binary && (t.type = "Blob"),
                                    o.data = t,
                                    o.data_type = "typified",
                                    e()
                                }
                                ))
                            }
                                ...
                                if (s)
                                    return s = !1,
                                    void i(o.onabort);
                                let e, r, l, d = ao.connect("xhr"), g = [], p = !1;
                                const {method: f, url: v, redirect: m, headers: _, cookie: b, binary: M, nocache: h, revalidate: y, timeout: w, context: E, responseType: S, overrideMimeType: R, anonymous: G, fetch: L, user: O, password: C, data: I, data_type: T} = o
                                  , x = Lt({
                                    method: f,
                                    url: v,
                                    redirect: m,
                                ...
                                const N = async t=>{
                                    if (t && (l || void 0 !== e || void 0 !== r)) {
                                        ...
                                        l)
                                            ...
                                            const e = r;
                                            if (D = e.buffer,
                                            -1 == Ht(["blob", "arraybuffer"], U) && !P) {
                                                let t;
                                                $t([k, e.type], (e=>t = ((e,t,n,o)=>{
                                ...
                                "stream" === U && q((async()=>{
                                    l = await to((e=>{
                                        const t = new eo.ReadableStream(Lt({
                                            start: n=>{
                                                Bo((()=>e(Lt({
                                                    stream: t,
                                                    ctrl: n
                                ...
                                d.onMessage.addListener((t=>q((()=>(async t=>{
                                    if (t.onpartial) {
                                        const n = t.data
                                          , o = n
                                          , s = o.partial
                                        ...
                                        if (l) {
                                            ...
                                            if (void 0 !== s)
                                                ...
                                                Zn.error(`${f}:`, "data message without data?!")
                                        } else {
                                            let t;
                                            s && Bt(g, s),
                                            a && (t = a),
                                            void 0 !== o.index && o.index !== o.length - 1 || (g.length && (e = qt(g, ""),
                                            g = []),
                                            r = t)
                                        }
                                    } else {
                                        ...
                                        t.onload)
                                            await N(e),
                                            i(o.onreadystatechange, e),
                                            i(o.onload, e);
                                        else if (t.onreadystatechange)
                                            await N(e),
                                            4 != e.readyState && i(o.onreadystatechange, e);
                                        else if (t.onerror)
                                            t.exception && Zn.error(t.exception),
                                            i(o.onerror, e);
                                        else if (t.onabort)
                                            i(o.onabort, e);
                                        else if (t.ondone)
                                            p = !0,
                                            l && !l.canceled && (pn || (e=>e.close()))(l.ctrl),
                                            await N(e),
                                            i(o.onloadend, e);
                                            ...
                                            o.upload && i(o.upload.onprogress, e);
                                        else {
                                            const n = Hn(Nt(["onprogress", "ontimeout"], (e=>!!t[e])), 0) || "onerror";
                                            i(o[n], e)
                                        }
                                    }
                                }
                          ...
                          , r = (()=>{
                            ...
                            return Wt(["text", "arraybuffer", "blob", "document", "json", "stream"], (t=>{
                        ...
                        return Wt(pt(r), (e=>Ot(o, e, r[e]))),
                        Lt({
                            GM_xmlhttpRequest: e ? Lt({
                                value: o
                            }) : void 0,
                            "GM.xmlHttpRequest": e ? Lt({
                                get: ()=>{
                                    const e = e=>l(o, e);
                                    return Wt(pt(r), (t=>Ot(e, t, r[t]))),
                                    e
                                }
                            }) : void 0
                        })
                      ...
                      , m = (()=>{
                        ...
                        const o = ()=>{
                            if (!n) {
                                const {script: o} = e
                                  , {antifeatures: r, author: s, blockers: a, copyright: i, deleted: l, description_i18n: c, description: d, downloadURL: u, fileURL: g, grant: p, header: f, homepage: v, icon: m, icon64: _, lastModified: b, name_i18n: M, name: h, namespace: y, position: w, resources: E, supportURL: S, system: R, updateURL: G, version: L, webRequest: O, options: {override: {orig_connects: C, orig_excludes: I, orig_includes: T, orig_matches: x}, run_at: P, unwrap: D}} = o
                                  , {downloadMode: A, inIncognitoContext: k, relaxedCsp: U, isFirstPartyIsolation: $, sandboxMode: j, userAgent: F, version: N} = t
                                  , V = G || g
                                  , q = Lt({
                                    antifeatures: r,
                                    author: s,
                      ...
                      , b = (()=>{
                        ...
                        const n = Lt({})
                          , o = (e,o,s)=>{
                            ...
                            const a = ao.connect("registerMenuCommand", !0)
                              , {accessKey: i, autoClose: l, title: d, id: u} = "string" == typeof s ? Lt({
                                accessKey: s
                            }) : s || Lt({})
                              , g = void 0 !== u ? u : ++t;
                        ...
                        ;
                        return Lt({
                            GM_registerMenuCommand: e ? Lt({
                                value: o
                            }) : void 0,
                            "GM.registerMenuCommand": e ? Lt({
                                get: ()=>a(o)
                            }) : void 0,
                            GM_unregisterMenuCommand: e ? Lt({
                                value: r
                            }) : void 0,
                            "GM.unregisterMenuCommand": e ? Lt({
                                get: ()=>a(r)
                            }) : void 0
                        })
                    }
                          ...
                          , t = (e,t,n,o)=>{
                            ...
                            if ("object" == typeof e) {
                                ...
                                r = Lt({
                                    id: s,
                                    text: e,
                                    title: "string" == typeof t ? t : c.name,
                                    image: n || c.icon64 || c.icon || void 0
                                });
                            r.onclick = o,
                            r.ondone = a || void 0,
                            ((e,t)=>{
                                const {text: n, title: o, tag: r, url: s, image: a, highlight: i, silent: l, timeout: d, onclick: u, ondone: g} = Zt(t);
                                if (n || i) {
                                    ...
                                    Zn.warn("GM_notification: neither a message text nor highlight options were given!")
                            }
                            )(s, r)
                        }
                        ;
                        return Lt({
                            GM_notification: e ? Lt({
                                value: t
                            }) : void 0,
                            "GM.notification": e ? Lt({
                                get: ()=>(e,n,o,r)=>{
                                    let s;
                                    return s = "object" == typeof e ? e : Lt({
                                        text: e,
                                        title: n,
                                        image: o,
                                        onclick: r
                        ...
                        const e = s(c.grant, yo)
                          ...
                          , n = (e,n)=>{
                            ...
                            g.onMessage.addListener((e=>{
                                ...
                                try {
                                    e.load ? (o.onload && r(o.onload, e.data),
                                    p()) : e.progress ? o.onprogress && r(o.onprogress, e.data) : e.timeout ? (o.ontimeout && r(o.ontimeout, e.data),
                                    p()) : (o.onerror && r(o.onerror, e.data),
                                    p())
                                } catch (e) {
                        ...
                        const e = s(c.grant, Go)
                          , t = (e,t)=>{
                            ...
                            i.onMessage.addListener((e=>{
                                e.tabId ? r ? l() : (i && void 0 === n && i.connectMessage(Lt({
                                    method: "openTab",
                                    uuid: c.uuid,
                                    tabId: e.tabId
                                }), !1),
                                n = e.tabId,
                                a.run()) : e.name ? o = e.name : e.closed && (r = !0,
                                s && (s(),
                                s = null),
                                i && i.stopReconnecting())
                            }
                            )),
                      ...
                      , C = (()=>{
                        const e = s(c.grant, mo)
                          , t = (e,t)=>{
                            o.first.send("backgroundControl", Lt({
                                uuid: c.uuid,
                                restart: "restart" === e.action || void 0
                            }), t ? ({error: e})=>t(e) : null)
                        }
                        ;
                        return Lt({
                            "GM.backgroundControl": e ? Lt({
                                get: ()=>a(t)
                            }) : void 0
                        })
                    }
                    ...
                    return r[e.script.uuid] = r[e.script.uuid] || I,
                    r[e.script.uuid]
                }
            })
        }
          , Yo = (e,t,n,o,r,s)=>{
            ...
            const l = Lt({})
              ...
              , d = (e,o,r)=>{
                let d, g;
                null === o || ("object" == typeof o ? (d = async e=>{
                ...
                if (void 0 !== d) {
                    ...
                    if ("string" != typeof d) {
                        ...
                        l[t] = l[t] || [];
                        const n = function(...t) {
                            return "object" == typeof r && r.once && u(e, o, r),
                            Gt(d, this === Yn || this === Qn ? p : this, t)
                        }
                          , s = Lt({
                            listener: d,
                            filter: n,
                        ...
                        m = n,
                        c)
                            return void c.value.register(n)
                    } else {
                        if (c)
                            return void Zn.warn("env: urlchange listener must be a function!");
                        m = d
                    }
              ...
              , u = (e,t,o)=>{
                ...
                if (g && g.length) {
                    ...
                    return a(eo.removeEventListener, [e, r, o], 1, !0)
            }
              , g = Lt({
                CDATA: Lt({
                    value: function(e) {
                ...
                setInterval: Lt({
                    value: (...e)=>a(Jo, e, 0, !0, p)
                }),
                close: (()=>{
                    const e = n["window.close"];
                    return e ? Lt({
                        get: ()=>Yn == Yn.top ? t=>e.value(t) : eo.close
                    }) : void 0
                }
                )(),
                focus: (()=>{
                  ...
                  , p = (e,t)=>{
                    const {m: n, a: r, r: s, n: a} = t
                      , i = ((e,t,n)=>{
                        let r;
                        var s;
                        return n ? (r = no("MutationEvent"),
                        tn(r, e, !1, !1, n || null, void 0, void 0, kt(t), nn)) : r = new Fn(e,Lt({
                            detail: (s = t,
                            o ? o(s, Yn.document) : s)
                        })),
                        r
                  ...
                  , f = t=>{
                    ...
                    "unlock" == n)
                        ...
                        s(Lt({
                            method: n,
                            args: i,
                            node: "MutationEvent" === en(t) ? Cn(t) : void 0
                        }), r)
                    }
                }
                  , v = e=>{
                    e && (a = e),
                    a && eo.addEventListener(`${n}_${a}`, f, !0)
                }
                ;
                let m, _;
                const b = ()=>{
                  ...
                  , M = Lt({
                    ...
                    ,
                    cleanup: ()=>{
                        a && (eo.removeEventListener(`${n}_${a}`, f, !0),
                        a = void 0)
                    }
                });
                return M
            ...
            o.setMessageListener((({method: t, args: n})=>{
                if ("commid" == t)
                    ...
                    const {id: t, unwrap: r, bundle: s} = n
                      , {script: a} = s
                      , {name: i, uuid: l, options: {run_at: u}} = a;
                    g(t, (t=>{
                        const o = r ? ()=>t() : ()=>Gt(t, ((t,n,o,r)=>{
                    ...
                    delete c[e]) : l.warn(`env: missing script "${e}"!`)
                }
            }
            ));
                    ...
                    createProxy: n=>{
                        ...
                        const f = new $n(p,Lt({
                            defineProperty: (e,t,o)=>{
                                const {d: r, l: d} = s(t)
                                  , u = Lt(o);
                                return r && !r.configurable && (!!r.configurable != !!u.configurable || !!r.enumerable != !!r.enumerable) || a(t) ? (_t(d ? p : Yn, t, u),
                                !1) : (_t(p, t, u),
                                l(t) && i(t) && c(t),
                                delete n[t],
                                !0)
                            ...
                            deleteProperty: (e,t)=>{
                                let {d: a, l: d, w: u} = s(t);
                                return !(!a || !a.configurable) && (d && (d = delete p[t],
                                l(t) && i(t) && c(t)),
                                (u || (a = r[t]) && a.configurable) && (o === r && (r = vt(Lt({}), o)),
                                u = delete r[t]),
                                delete n[t],
                                d || u)
                            }
                            ...
                            get: (e,t)=>{
                                ...
                                const {d: r, l: i} = a(t) ? Lt({
                                    d: Mt(Yn, t),
                                    l: !1
                                }) : s(t);
                                if (r) {
                                    let e;
                                    const n = "value"in r ? Ct(r, "value") : (e = Ct(r, "get")) && "function" == typeof e ? i ? e() : Dt(e, Yn)() : void 0;
                            ...
                            ownKeys: ()=>{
                                const e = e=>!(e in r)
                                  ...
                                  , n = Nt(pt(yt(p)), e)
                                  , o = Lt({});
                                for (let e = 0; "Window" === en(It(Yn, e)); e += 1)
                                    o[e] = !0;
                                const s = Nt(pt(o), e);
                                return Xt(t, n, s)
                            }
                            ...
                            set: (e,t,o)=>{
                                ...
                                if (r && r.set)
                                    ...
                                    !0;
                                const {d} = s(t);
                                return !(d && !d.writable && !Ct(d, "set") || a(t) || (delete n[t],
                                Ot(p, t, o),
                                l(t) && i(t) && c(t, o),
                                0))
                            }
