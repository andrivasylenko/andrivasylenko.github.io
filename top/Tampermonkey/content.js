((twod,k)=>{
    ...
    (()=>{
        ...
        const o = twod.vault = twod.vault || t(twod.unsafeWindow)
          , {cSO: s, F_c: r, F_a: i, F_b: a, F_tS: c, A_fE: d, A_so: l, A_sh: u, A_j: p, A_f: m, A_iO: g, A_iA: f, O_a: _, O_k: v, O_v: h, O_dP: b, O_dPy: w, O_hOP: y, O_gOPN: M, O_gOPD: E, O_gOPDs: L, O_gPO: S, O_tS: O, J_p: x, J_s: R, M_f: I, M_r: j, M_m: D, M_mi: C, M_i: P, M_pA: $, M_pAT: A, N_tS: T, N_MSI: U, P_t: N, P_c: B, R_rABS: F, R_rAT: k, R_r: X, R_enq: q, R_cl: W, S_fCC: H, S_sl: J, S_su: G, S_iO: K, S_sp_nr: z, S_tr: V, S_rA_nr: Y, S_cCA: Z, S_tLC: Q, S_tUC: ee, Y_tST: te, D_pFS: ne, D_cS: oe, D_gRS: se, D_cE: re, D_gEBT: ie, E_r: ae, E_s: ce, E_rA: de, M_aN: le, M_rN: ue, C_d: pe, U_cOU: me, U_rOU: ge, USP_tS: fe, X_o: _e, X_s: ve, X_pSD: he, X_pSH: be, X_pSL: we, X_pSO: ye, X_pSU: Me, D_n: Ee, I_tS: Le, W_aEL: Se, W_rEL: Oe, parseInt: xe, parseFloat: Re, console: Ie, encodeURIComponent: je, decodeURIComponent: De, encodeURI: Ce, decodeURI: Pe, escape: $e, unescape: Ae, atob: Te, btoa: Ue, postMessage: Ne, dispatchEvent: Be, alert: Fe, prompt: ke, confirm: Xe, close: qe, getElementById: We, createEvent: He, createElement: Je, CustomEvent: Ge, CompositionEvent: Ke, KeyboardEvent: ze, MouseEvent: Ve, MutationEvent: Ye, MutationObserver: Ze, Uint8Array: Qe, FileReader: et, DOMParser: tt, XMLHttpRequest: nt, Function: ot, RegExp: st, Promise: rt, Blob: it, ReadableStream: at, Number: ct, String: dt, Proxy: lt, Window: ut} = o
          , pt = r
          , mt = i
          , gt = v
          , ft = h
        ...
        const En = twod.console = twod.console || Ot({})
          , Ln = Ot({
            addEventListener: Ct(Se, yn),
            removeEventListener: Ct(Oe, yn)
        });
        Ft(gt(bn), (async e=>{
            if (!Ln[e])
                try {
        ...
        Ft(gt(vn), (async e=>{
            if (!Ln[e])
                try {
                    let t = Rt(yn, e);
                    if (void 0 === t && (Mn === yn || void 0 === (t = Rt(Mn, e))))
                        return;
                    const n = vn[e];
        ...
        const Sn = e=>{
          ...
          , {setInterval: Rn, setTimeout: In, clearInterval: jn, clearTimeout: Dn, console: Cn, cloneInto: Pn, exportFunction: $n, createObjectIn: An} = yn
          , Tn = Object.assign({}, Cn)
          , Un = Rn.bind(yn)
          , Nn = In.bind(yn)
          , Bn = jn.bind(yn)
        ...
        (e,t)=>{
          ...
          , to = (e,t)=>{
            ...
            return "string" == typeof t ? n.append(t) : t && Ft(gt(t), (e=>{
        ...
        function(e) {
          ...
          , So = (()=>{
            ...
            return Object.defineProperty(e, "inIncognitoContext", {
                get: ()=>(void 0 === t && (t = yo.extension.inIncognitoContext),
                t),
                set: e=>{
                    t = e
                }
          ...
          , Oo = yo.userScripts && yo.userScripts.onBeforeScript ? {
            supported: !0,
            onBeforeScript: {
        ...
        Sn((async t=>{
          ...
          , Fo = Ot({
            ...
            openInTab: e=>{
                ...
                e.onMessage.addListener((e=>{
                    if ("openTab" == e.method) {
                        let n = e.url;
                        const {active: o, loadInBackground: s, insert: r, incognito: i, setParent: a} = "boolean" == typeof e.options || void 0 === e.options ? Ot({
                        ...
                        void 0 !== e.name ? t.postMessage(Ot({
                            name: e.name,
                            uuid: e.uuid
                        })) : e.focus ? t.postMessage(Ot({
                            focus: !0,
                            uuid: e.uuid
                        })) : e.close && t.postMessage(Ot({
                            close: !0,
                            uuid: e.uuid
                        }))
                }
          ...
          , ko = Ot({
            ...
            setClipboard: ({args: e, cb: t})=>{
                ...
                ho ? So.sendMessage(Ot({
                    method: "clipboard",
                    mimetype: a,
                    content: n,
                    uuid: s
                }), (()=>t())) : (yn.document.addEventListener("copy", (e=>{
        ...
        const Go = (e,t,n,o,s)=>{
            ...
            Ft(t, (async t=>{
                ...
                ,
                w = "context-menu" == l || "document-start" == l ? void 0 : ()=>{
        ...
        (async()=>{
            ...
            Sn((e=>{
                ...
                var m;
                if (p && (m = p).scripts && m.contexters && (Mn.tm_info = p),
                i) {
                    const e = Io ? zo(`() => ${d};`)() : d
                                  ...
                                  , m = (e,t)=>{
                                    const {m: n, a: s, r, n: i} = t
                                      , a = ((e,t,n)=>{
                                        ...
                                        zt(s, e, !1, !1, n || null, void 0, void 0, $t(t), Vt)) : s = new mn(e,Ot({
                                            detail: (r = t,
                                            o ? o(r, yn.document) : r)
                                        })),
                                        s
                ...
                So.onMessage.addListener(((e,t,n)=>{
                    "executeScript" == e.method ? (e.url && 0 !== tn(r.href, e.url) || void 0 !== e.topframe && e.topframe != Fn || ss(e.info, !1),
                    n(Ot({}))) : Fn && ("loadUrl" == e.method ? (o.location = e.url,
                    n(Ot({}))) : "reload" == e.method ? (r.reload(),
                    n(Ot({}))) : "setForeignAttr" == e.method ? (s.first.send(e.method, e),
                    n(Ot({}))) : Tn.log("content: unknown method " + $t(e)))
                }
                )),
                ...
                ((t,n,o)=>{
                    ...
                    Sn((e=>{
                        const o = t=>{
                            ...
                            const o = ()=>{
                                ...
                                So.sendMessage({
                                    ...
                                    if (!os) {
                                        ...
                                        os = !0,
                                        s.nonce && ao(s.nonce),
                                        gt(s.contexters).length || gt(s.scripts).length || s.external_connect ? (t && t(s),
                                        e({
                                            info: s,
                                            type: "complete" == sn(yn.document) ? "late" : "normal"
                                        })) : e({
                                            info: s
                                        })
                                    }
                          ...
                          , r = ()=>{
                            let r;
                            if (Qo && i.log("content: Started (" + s + ", " + window.location.origin + window.location.pathname + ")", Mn.tm_info),
                            (r = Mn.tm_info) || (r = ns())) {
                                delete Mn.tm_info,
                                r.nonce && ao(r.nonce);
                        ...
                        c) {
                            ...
                            e(!1, (()=>{
                                ...
                                Ft(gt(r), (e=>r[e].send("DOMContentLoaded")))
                            }
                            )),
                            l = ()=>{
                                Qo && i.log("content: load"),
                                Ft(gt(r), (e=>r[e].send("load")))
                            }
                            ,
                            "complete" == sn(yn.document) ? l() : Ln.addEventListener("load", (()=>l()), Ot({
                                capture: !0,
                                once: !0
                            }));
                            ...
                            ss(a, "sync" === c),
                            !Fn && u && window.addEventListener("unload", (()=>{
                                So.sendMessage({
                                    method: "unLoad",
                                    id: s,
                                    topframe: !1,
